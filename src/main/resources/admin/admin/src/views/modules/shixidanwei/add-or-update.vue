<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="单位性质" prop="danweixingzhi">
          <el-input v-model="ruleForm.danweixingzhi" 
              placeholder="单位性质" clearable  :readonly="ro.danweixingzhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="单位性质" prop="danweixingzhi">
              <el-input v-model="ruleForm.danweixingzhi" 
                placeholder="单位性质" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shixidanwei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shixidanweiCrossAddOrUpdateFlag = false;
						 this.parent.search();
