<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">实习管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   <div class="label">学生学号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xueshengxuehao" class="input" type="text" placeholder="学生学号">
			   </div>
			 </div> -->
			<el-form-item label="学生学号" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.xueshengxuehao" autocomplete="off" placeholder="学生学号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			...
			<!-- <div v-if="tableName=='shixidanwei'" class="input-group">
			   <div class="label">单位名称</div>
			   <div class="input-container">
			     <input v-model="ruleForm.danweimingcheng" class="input" type="text" placeholder="单位名称">
			   </div>
			 </div> -->
			<el-form-item label="单位名称" class="input" v-if="tableName=='shixidanwei'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='shixidanwei'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='shixidanwei'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<!-- <div v-if="tableName=='shixidanwei'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.danweixingzhi" class="input" type="text" placeholder="单位性质">
			   </div>
			 </div> -->
			<el-form-item label="单位性质" class="input" v-if="tableName=='shixidanwei'">
			  <el-input v-model="ruleForm.danweixingzhi" autocomplete="off" placeholder="单位性质"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shixidanwei'" class="input-group">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='shixidanwei'">
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='shixidanwei'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='shixidanwei'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shixidanwei'" class="input-group">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='shixidanwei'">
			...
			<el-form-item label="单位地址" class="input" v-if="tableName=='shixidanwei'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.danweimingcheng) && `shixidanwei` == this.tableName){
        this.$message.error(`单位名称不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `shixidanwei` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `shixidanwei` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if((!this.ruleForm.lianxidianhua) && `shixidanwei` == this.tableName){
        this.$message.error(`联系电话不能为空`);
        return
      }
      if(`shixidanwei` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
        this.$message.error(`联系电话应输入手机格式`);
        return
      }
      if(`shixidanwei` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
